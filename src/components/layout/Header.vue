<script setup>
  ...
  onMounted(() => {
    console.log(`Mounted ${state.value.name}`)
    fetchData()
  })
...
<template>
  <div class="navbar bg-transparent p-4 !text-white">
    <div class="navbar-start">
      <div class="dropdown">
        ...
        >
          <li>
            <label for="my_modal_about" class="btn btn-ghost btn-circle">
              About
            </label>
          </li>
          <li><a href="https://github.com/trentbrew/timer">Source Code</a></li>
          <li><a href="mailto:hello@trentbrew.com">Feedback</a></li>
        </ul>
      </div>
    </div>
    <div class="navbar-center"></div>
    <div class="navbar-end">
      <label for="my_modal_settings" class="btn btn-ghost btn-circle">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clip-path="url(#clip0_633_11255)">
            <path
